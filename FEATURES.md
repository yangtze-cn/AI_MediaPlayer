...
- [x] **亮度控制**：支持 0.0 - 1.0 的屏幕亮度调节

#### 1.3 手势控制
- [x] **双击暂停/播放**：双击视频区域可快速切换播放状态
- [x] **单击切换控制界面**：单击视频区域显示/隐藏播放控制界面
- [x] **控制界面自动隐藏**：无交互 3 秒后自动隐藏控制界面，提供沉浸式观看体验
- [x] **右侧垂直滑动调节音量**：在屏幕右侧上下滑动调节音量（0.0 - 1.0）
- [x] **左侧垂直滑动调节亮度**：在屏幕左侧上下滑动调节屏幕亮度（0.0 - 1.0）
- [x] **水平滑动调节进度**：左右滑动快速调节播放进度
- [x] **手势视觉反馈**：手势操作时显示浮层提示当前值（音量图标、亮度图标、进度时间）
- [x] **交互时重置隐藏定时器**：任何交互操作（手势、点击按钮）都会重新计时
